...
#CAMBIO DE CONSTRASEÑA SITIO CHILENO
driver.get(site+'my-account/')
sleep(5)
input_old_password = driver.find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div/div/div/div/article/div/div/section/div/div/div/div[1]/div/div[2]/form/div/div[2]/div[1]/input')
input_new_password = driver.find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div/div/div/div/article/div/div/section/div/div/div/div[1]/div/div[2]/form/div/div[2]/div[2]/input')
reinput_new_password = driver.find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div/div/div/div/article/div/div/section/div/div/div/div[1]/div/div[2]/form/div/div[2]/div[3]/input')
input_change_password = driver.find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div/div/div/div/article/div/div/section/div/div/div/div[1]/div/div[2]/form/div/div[3]/button')
sleep(3) 
input_old_password.send_keys(passwordchange) 
sleep(2) 
input_new_password.send_keys(password) 
sleep(2) 
reinput_new_password.send_keys(password)  
sleep(2)
try:
